...
RSpec.describe BreaksController, type: :controller do
  ...
  # Break. As you add validations to Break, be sure to
  ...
  # BreaksController. Be sure to keep this updated too.
  let(:valid_session) { {} }

  describe "GET #index" do
    it "assigns all breaks as @breaks" do
      break = Break.create! valid_attributes
      get :index, params: {}, session: valid_session
      expect(assigns(:breaks)).to eq([break])
    end
  end
  ...
  describe "GET #show" do
    it "assigns the requested break as @break" do
      break = Break.create! valid_attributes
      get :show, params: {id: break.to_param}, session: valid_session
      expect(assigns(:break)).to eq(break)
    end
  end
  ...
  describe "GET #edit" do
    it "assigns the requested break as @break" do
      break = Break.create! valid_attributes
      get :edit, params: {id: break.to_param}, session: valid_session
      expect(assigns(:break)).to eq(break)
    end
  end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested break" do
        break = Break.create! valid_attributes
        put :update, params: {id: break.to_param, break: new_attributes}, session: valid_session
        break.reload
      ...
      it "assigns the requested break as @break" do
        break = Break.create! valid_attributes
        put :update, params: {id: break.to_param, break: valid_attributes}, session: valid_session
        expect(assigns(:break)).to eq(break)
      end
      ...
      it "redirects to the break" do
        break = Break.create! valid_attributes
        put :update, params: {id: break.to_param, break: valid_attributes}, session: valid_session
        expect(response).to redirect_to(break)
      end
    end
    ...
    context "with invalid params" do
      it "assigns the break as @break" do
        break = Break.create! valid_attributes
        put :update, params: {id: break.to_param, break: invalid_attributes}, session: valid_session
        expect(assigns(:break)).to eq(break)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested break" do
      break = Break.create! valid_attributes
      expect {
        delete :destroy, params: {id: break.to_param}, session: valid_session
      }.to change(Break, :count).by(-1)
    end
